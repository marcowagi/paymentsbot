...
class User(Base):
    ...
    is_temporary_admin = Column(Boolean, default=False)
...
class AuditLog(Base):
    ...
    id = Column(Integer, primary_key=True)
    action = Column(String(50), nullable=False)  # "add_admin", "remove_admin", etc.
    performed_by = Column(Integer, nullable=False)  # Admin telegram_id who performed the action
    target_user_id = Column(Integer)  # User telegram_id who was affected
